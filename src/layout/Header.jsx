...
const NavLinks = () => (
    <>
        <a href="#" className="transition text-text-muted hover:text-text-light">Instant Buy & Sell</a>
        <a href="#" className="transition text-text-muted hover:text-text-light">Markets</a>
        <a href="#" className="transition text-text-muted hover:text-text-light">Discover</a>
    </>
);
...
export default Header;// src/sections/Hero.jsx